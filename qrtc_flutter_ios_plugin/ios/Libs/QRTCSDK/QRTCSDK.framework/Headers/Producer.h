...
//just for store
@property(nonatomic, assign) NSInteger _bytesLastSent;
@property(nonatomic, assign) NSInteger _framesLastSent;

-(instancetype)initWithNativeProducer:(NSValue *)nativeProducer factory:(RTCPeerConnectionFactory*)factory;
 ...
 */
-(void)replaceTrack:(RTCMediaStreamTrack *)track factory:(RTC_OBJC_TYPE(RTCPeerConnectionFactory) *)factory;
/*!
